...
INSERT INTO `cs_registered_config`(`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918bt', '第三方认证配置-部署地址', 'xxx.url', 'http://10.1.135.40:5020', 'jhome-account', 0, 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', 0);
INSERT INTO `cs_registered_config`(`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918bu', '第三方认证配置-加密秘钥', 'xxx.signature', 'ky6xbsOp1UotNvz3H7fI', 'jhome-account', 0, 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', 0);
INSERT INTO `cs_registered_config`(`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918bv', '第三方认证配置-产品ID', 'xxx.appId', 'OhtZG', 'jhome-account', 0, 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', 0);
